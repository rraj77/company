    ...
    <Grid container spacing={2} className={styles.footer}>
      ...
      <Grid lg={4} xs={12} md={12}>
        ...
        <Typography className={styles.font_size}>
          <LocationOnIcon className={styles.icon_size} color="primary" />{" "}
          &nbsp;58, PU4, 4th floor, behind C21 mall, scheme no 54 Bhind C21 Mall
      ...
      <Grid lg={4} xs={12} md={12}>
        ...
        <Typography className={styles.font_size}>
          We offer Web Development services in different countries. · Ruby on
          rails, reactJS, angularJS and many more application support currently
          we are providing.
        </Typography>
      </Grid>
    </Grid>
